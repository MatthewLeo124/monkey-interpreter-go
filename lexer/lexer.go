...
func (l *Lexer) NextToken() token.Token {
	...
	l.skipWhitespace() //eat whitespace as it doesn't have semantic meaning for this language
...
// Does not support floats or hex or octal notation. This can be added later as an exercise
